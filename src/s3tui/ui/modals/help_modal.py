...
class HelpModal(ModalScreen[bool]):
    """Modal screen displaying help information and keybindings for S3TUI."""
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="help-dialog"):
            ...
            with Container(id="help-dialog-header"):
                yield Label("S3TUI Help", classes="dialog-title")
                yield Label("Navigation, keybindings, and usage information | ESC to exit", classes="dialog-subtitle")
            ...
            with ScrollableContainer(id="help-dialog-content"):
                ...
                with Vertical(classes="help-section"):
                    ...
                    yield Static(
                        "S3TUI is a terminal-based file manager for Amazon S3 and S3-compatible services.\n"
                ...
                with Vertical(classes="help-section"):
                    ...
                    with Container(classes="help-keybindings"):
                        ...
                        yield self._create_keybinding_row("↑/↓", "Navigate up/down in lists")
